...
* [UrlFetchApp](https://developers.google.com/apps-script/reference/url-fetch/) - This service allows scripts to access other resources on the web by fetching URLs.
